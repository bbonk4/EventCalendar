...
void main() {
  ...
  test('Check Json', () {
    final calendar = Calendar(id: "calendarId", title: "My Calendar");
    calendar.addEvents([Event.fromJson(Event(DateTime.fromMillisecondsSinceEpoch(1588063107000),recurrenceRule: RecurrenceRule(Frequency.daily,interval: 2, count: 2), title: "Thing 1", id: "1").toJson()),
